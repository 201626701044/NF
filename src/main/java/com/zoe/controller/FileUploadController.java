...
public class FileUploadController {
    ...
    public @ResponseBody void fileupload(final HttpServletRequest request,
        ...
        System.out.println("hereaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
...
/*        String method = request.getParameter("method").toString();
        ...
        //   JSONArray jArray = new JSONArray(Collections.singletonList(jsonData));//假设str是你在服务端接收到的json字符串.

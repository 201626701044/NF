...
<div class="main">
    ...
    <div  class="title ">
        <ul>
            <li><a href="index.jsp" class="all" >房源信息</a></li>
    ...
    <div class="content">
        ...
        <div class="content-left">
            <div id="outer">
                <!--房屋图片-->
                <ul id="imgList">
                    <li><img src="${c.rentrequests.get(status.index).reqId}" alt="" width="200px" height="300px"></li>
                </ul>
            </div>
        </div>
        ...
        <div class="content-right">
            <div class="content-right-top">
                <p class="one"><a href="#">${c.rentrequests.get(status.index).city}</a></p>
                <p class="two">${c.rentrequests.get(status.index).reqTime} </p>

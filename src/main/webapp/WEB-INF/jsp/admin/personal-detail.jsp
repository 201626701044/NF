...
<div class="header">
    ...
    <ul>
        <li><a href="#">用户帮助</a></li>
        <c:if test="${not empty members.get(status.index).member_name}">
            <li ><a href="#">wellcome,${members.get(status.index).member_name}</a></li>
            <li ><a href="#">退出</a></li>
        </c:if>
    </ul>
</div>
...
<div class="nav">
    <ul class="nav-left">
        <li  class="lis "><a href="javaScript:;">个人资料</a></li>
        <li   class="lis"><a href="javaScript:;">信息修改</a></li>
        <li   class="lis"><a href="javaScript:;">我的收藏</a></li>
        <li   class="lis"><a href="javaScript:;">我的动态</a></li>
        <li   class="lis"><a href="javaScript:;">访客足迹</a></li>
        <li class="long"></li>
    </ul>
</div>

<div class="nav-right">
    <div id="d1" class="holder divs" style="display:block">
        <ul class="nav-right-ul">
            ...
            <li class="second photo">
                ...
                <img class="photo01" src="${members.get(status.index).member_image}" alt="个人头像">
                <!--<span  class="photo02"><a id="myphoto" href="#">修改</a></span>-->
            </li>
            <li class="second name">
                <span class="describe">昵&nbsp;称</span>
                <span class=" name01">${members.get(status.index).member_name}</span>
                <!--<span class="photo02"><a href="#">修改</a></span>-->
            </li>
            <li class="second sex">
                <span class="describe">性&nbsp;别</span>
                <span class=" name01">${members.get(status.index).member_sex}</span>
            ...
            <li class="second phone">
                ...
                <span class=" name01">${members.get(status.index).member_phone}</span>
                <!--<span class="photo02"><a href="#">修改</a></span>-->
            </li>
            <li class="second phone">
            </li>
    ...
    <div id="d2" class="holder01 divs">
        <ul class="nav-right-ul01">
            ...
            <li class="third xg-photo">
                ...
                <img class="xg-photo01" src="${members.get(status.index).member_image}" alt="个人头像">
    ...
    <div id="d3" class="holder01 divs">
        3333
    </div>
    <div id="d4" class="holder01 divs">
        4444
    </div>
    <div id="d5" class="holder01 divs">
        5555
    </div>
</div>

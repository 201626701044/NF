...
<form action="updateMember" method="post" enctype="multipart/form-data">
    用户名称：
    <input type="text" name="member_name" value="${member.member_name }"/><br/><br/>
    原始图片：
    <img src="${baseUri}/upload/${member.member_image}" width="100px" height="100px"/><br/><br/>
    ...
    <input type="hidden" name="id" value="${member.member_ID}"/><!-- 隐藏 -->
